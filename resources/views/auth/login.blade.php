    ...
    <form action="{{ route('login') }}" method="POST" class="space-y-6" x-data="{ loading: false }"
        ...
        <div class="relative">
            ...
            <a href="{{ route('password.request') }}"
                class="absolute right-0 top-0 text-sm font-semibold text-neutral-700 underline underline-offset-4 decoration-neutral-700/30 hover:decoration-neutral-700 transition-colors duration-300">
                Esqueceu sua senha?
            </a>
