<x-layouts.app>
    <div class="max-w-7xl mx-auto">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-neutral-900">Dashboard do Administrador</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <x-card>
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-neutral-600">Total de Cursos</p>
            ...
            <x-card>
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-neutral-600">Coordenadores</p>
                        <p class="text-3xl font-bold text-neutral-900">0</p>
                    </div>
                    <div class="w-12 h-12 bg-accent/10 text-accent rounded-lg flex items-center justify-center">
            ...
            <x-card>
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-neutral-600">Alunos no Sistema</p>
                        <p class="text-3xl font-bold text-neutral-900">0</p>
                    </div>
                    <div class="w-12 h-12 bg-accent/10 text-accent rounded-lg flex items-center justify-center">
